...
set_seed(42)
# Top 3500 features
# data_train = ad.read_h5ad("/home/anand/scFCSB_tool/apr18_fs_fc_1/Cell_Type/train_top_3500_features.h5ad")
# data_test = ad.read_h5ad("/home/anand/scFCSB_tool/apr18_fs_fc_1/Cell_Type/test_top_3500_features.h5ad")

# Top 3500 features from NN
data_train = ad.read_h5ad("/home/biocusp/data/pbmc_sle/train/pbmc_sle_train.h5ad")
data_val = ad.read_h5ad("/home/biocusp/data/pbmc_sle/val/pbmc_sle_val.h5ad")
data_test = ad.read_h5ad("/home/biocusp/data/pbmc_sle/test/pbmc_sle_test.h5ad")
...
print(data.X)
data.obs['celltype'] = data.obs['cell_type']
...
pipeline_config.update({"epochs": 2})
